...
<html>
  ...
  <body>
    ...
    <div id="wrapper">
      ...
      <main id="content">
        <div class = "content2">
        <div id="sejarah" class="scrollto clearfix">
          <div class="row no-padding-bottom clearfix">
              ...
              <div class="wow fadeInLeft" data-wow-delay="0.1s">
                ...
                <blockquote class="testimonial text-left bigtest">
                  <q
                    ...
                    antara bintang-bintang.</q
                  >
                  <footer>— Bung Karno</footer>
                </blockquote>
                </div>
                <!-- End of Testimonial-->
              </div>
              ...
              <div class="wow fadeInRight" data-wow-delay="0.1s">
                ...
                <blockquote class="testimonial text-left bigtest">
                  <q
                    ...
                    tapi perjuanganmu akan lebih sulit karena melawan bangsamu sendiri.</q
                  >
                  <footer>— Bung Karno</footer>
                </blockquote>
                </div>
            ...
            <div class="col-3-2">
              <div class="wow fadeInRight" data-wow-delay="0.1s">
                <img src="images/bungkarno2.png" alt="bungkarno" />
              </div>
            </div>
          </div>
          </div>
      ...
      <section id="tokoh" class="secondary-color text-center scrollto clearfix ">
            <div class="row clearfix">
                ...
                <div class="section-heading">
                    <h2 class="section-title1">Tokoh Proklamasi Kemerdekaan Indonesia</h2>
                </div>
        ...
        <section id="pricing" class="secondary-color text-center scrollto clearfix ">
            <div class="row clearfix">
                ...
                <div class="pricing-block col-3 wow fadeInUp" data-wow-delay="0.8s">
                    <div class="pricing-block-content">
                        <h3>Mohammad Yusuf Ronodipuro</h3>
                        <p class="pricing-sub">Duta Besar Indonesia.</p>
                        <div class="pricing">
                        <img src="images/yusuf.png"/>
                        </div>
                        <ul>
                            <li>Seseorang yang telah berjasa bagi Indonesia karena telah menyebarkan kabar merdekanya Indonesia tak lama setelah teks proklamasi dibacakan oleh Sukarno dan Bung Hatta pada 17 Agustus 1945.</li>
                        <br/>
                        <br/>
